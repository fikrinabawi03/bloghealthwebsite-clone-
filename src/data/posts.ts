                ...
                subchapters: [
                    {
                        ...
                        content: `
                            ...
                            <p className="mb-6">Kenapa suka fisika kuantum atau mekanika kuantum bukan suka sama dia (upss..😄)?  Sebenarnya satu alasan yaitu aku suka dengan tantangan apalagi dunia kuantum itu di dalamnya penuh dengan ketidakpastian. Nahh.. meskipun dunia kuantum di dalamnya penuh dengan ketidakpastian, tapi aku suka banget dengan Albert Einstein ungkapkan kalo Tuhan itu tidak sedang bermain dadu seperti yang ada di <a href="https://youtu.be/m0bCEYXcMF8?si=KD_3b02KaG0Tubck" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">video</a> ini (btw guyss, video ini menarik banget buat kalian yang suka fisika kuantum. Caranya, kalian tinggal klik saja kata dari video tersebut. Nanti kalian akan langsung diarahkan ke video tersebut). Dan dari prinsip Einstein ini, aku jadi merasa terdorong ke kehidupan juga. Next ke chapter berikutnya teman-teman😉✨.  </p>
                        `
                    }
                ]
            },
